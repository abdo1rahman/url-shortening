  ...
  return (
    <footer>
      ...
      <div className="footer-title">
        <p className="links-title">Features</p>
      ...
      <div className="footer-title">
        <p className="links-title">Resources</p>
        <div className="footer-links">
      ...
      <div className="footer-title footer-icons">
        {/* Facebook */}
        <svg
          className="footer-icon"
          id="facebook"
        ...
        >
          <defs>
            <radialGradient id="instaGradient" cx="0%" cy="100%" r="100%">
              <stop offset="0%" stopColor="red" />
              <stop offset="50%" stopColor="orange" />
              <stop offset="100%" stopColor="rgb(203, 26, 123)" />
            </radialGradient>
          </defs>

          {/* Solid white base layer */}
          <path
